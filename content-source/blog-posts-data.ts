...
export interface BlogPostLocal {
...
export const blogPosts: BlogPostType[] = [
 {
  ...
  author: {
    ...
    bio:
      "Founder of Zaza Technologies, PhD in Professional Education, 20+ years in learning & development",
  },
  ...
  seo: {
    title:
      "Welcome to Zaza Promptly: AI Tools That Save Teachers Time | Zaza Promptly",
    description:
      "Discover how Zaza Promptly's AI-powered toolkit helps teachers plan lessons, grade faster, and streamline parent communication.",
    keywords: [
      "AI education tools",
...
}, // ← end of the first post (note the comma)
