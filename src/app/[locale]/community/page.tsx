      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="text-center">
            <div className="text-4xl font-bold text-purple-600 mb-2">{t('community.stats.teachers')}</div>
            <div className="text-gray-600">Active Teachers</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-purple-600 mb-2">{t('community.stats.resources')}</div>
            <div className="text-gray-600">Shared Resources</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-purple-600 mb-2">{t('community.stats.success_stories')}</div>
