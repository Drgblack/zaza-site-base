    ...
    <section className="my-8" aria-labelledby={`row-${title.replace(/\s+/g, '-').toLowerCase()}`}>
      ...
      <div className="relative">
        ...
        <button
          ...
          className="absolute left-2 top-1/2 -translate-y-1/2 z-20 h-9 w-9 rounded-full border border-gray-200 bg-white/80 backdrop-blur hover:bg-white hover:shadow-lg transition-all duration-200 flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
        >
        ...
        <button
          ...
          className="absolute right-2 top-1/2 -translate-y-1/2 z-20 h-9 w-9 rounded-full border border-gray-200 bg-white/80 backdrop-blur hover:bg-white hover:shadow-lg transition-all duration-200 flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
        >
